...
function BaseComponent<T extends ElementType>({ className, ...rest }: CreateComponentArgs<T>) {
  return <Slot className={cn('scroll-mt-20', className)} {...rest} />;
}
...
export function useMDXComponents(): MDXComponents {
  return {
    ...
    h3: (props) => (
      <BaseComponent>
        <h3 className="text-2xl font-bold mt-5 mb-2 text-foreground" {...props} />
      </BaseComponent>
    ),
    h4: (props) => (
      <BaseComponent>
        <h4 className="text-xl font-bold mt-4 mb-2 text-muted-foreground" {...props} />
      </BaseComponent>
    ),
    h5: (props) => (
      <BaseComponent>
        <h5 className="text-lg font-bold mt-3 mb-2 text-muted-foreground" {...props} />
      </BaseComponent>
    ),
    h6: (props) => (
      <BaseComponent>
    ...
    li: (props) => <li className="my-2 marker:text-sandy-brown marker:font-bold" {...props} />,
    table: (props) => (
    ...
    img: (props) => (
      <div className="flex justify-center py-2">
        <div className="relative overflow-hidden rounded-lg shadow">
          <Image alt="" {...props} width={1200} height={800} className="w-full h-auto" />
        </div>
      </div>
    ),
  };
