    ...
    <div className="opacity-0 animate-fade-in-slide">
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        {project.tags.map((tag) => (
          <span
            key={tag}
            className="px-4 py-2 bg-white/10 text-white/80 border border-white/20 rounded-full text-sm font-light"
          >
            {tag}
          </span>
        ))}
      ...
      <div className="flex gap-4">
        ...
        {project.github && (
          ...
          >
            ...
            <svg
              className="w-5 h-5 transition-transform group-hover/github:translate-x-1"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path
